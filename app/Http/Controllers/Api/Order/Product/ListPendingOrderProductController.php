...
final class ListPendingOrderProductController extends AbstractApiController
{
    ...
    ): JsonResponse
    {
        ...
        $requestData['filter']['to_delete'] = true;
        ...
        $items = $dictionaryRepository->findAllBy($requestData, $sort, $limit, $offset);
