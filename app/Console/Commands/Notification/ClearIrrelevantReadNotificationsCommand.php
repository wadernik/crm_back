...
final class ClearIrrelevantReadNotificationsCommand extends Command
{
    protected $signature = 'notification:read:clear';

    protected $description = 'Clear old irrelevant read notifications';
    ...
    public function handle(): void
    {
        ...
        $this->info('Clearing read notifications...');

        $this->databaseNotificationManager->clearReadByDate($filterDate->format('Y-m-d H:i:s'));
