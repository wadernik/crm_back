...
final class OrderDraftCompositeRepository implements OrderDraftCompositeRepositoryInterface
{
    public function __construct(private readonly OrderDraftRepositoryInterface $inner)
    {
    }
    ...
    private function setupOrderComposite(Order $order): OrderComposite
    {
        ...
        foreach ($order->items as $item) {
            $items[] = $item->load('files');
        }

        $orderComposite->setOrderItems(...$items);
